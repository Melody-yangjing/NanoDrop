  ...
  <div>
    ...
    <div>
      <el-tabs v-model="activeName" @tab-click="handleClick" >
        <el-tab-pane label="NUCLEC ACIDS" name="first">NUCLEC</el-tab-pane>
        <el-tab-pane label="PROTEINS" name="second">PROTEINS</el-tab-pane>
        <el-tab-pane label="OD66" name="third">OD66</el-tab-pane>
        <el-tab-pane label="CUSTOM" name="fourth">CUSTOM</el-tab-pane>
        <el-tab-pane label="KINETICS" name="fourth">KINETICS</el-tab-pane>
      </el-tabs>
    </div>
    <!-- 底部 -->
    <div class="bottom">
