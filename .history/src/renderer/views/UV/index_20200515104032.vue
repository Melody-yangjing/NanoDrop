<template>
  <div class="uv-container">
    ...
    <div class="input-box">
      <input v-model="dataZoomStart" class='inp' placeholder="请输入：λ Start" @change='handleChangeStart'
        style="width: 130px;"></input>
      <input v-model="dataZoomEnd" class='inp' placeholder="请输入：λ End" @change='handleChangeEnd'
        style="width: 130px;"></input>
      <input v-model="Abs" class='inp' placeholder="请输入：λ Abs" @change='handleChangeAbs' style="width: 130px;">
      </input>
    </div>
