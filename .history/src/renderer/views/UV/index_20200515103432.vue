...
<div>
  ...
  <div class="input-box">
    <el-input v-model="dataZoomStart" class='inp' placeholder="请输入：λ Start" @change='handleChangeStart'
      style="width: 130px;"></el-input>
    <el-input v-model="dataZoomEnd" class='inp' placeholder="请输入：λ End" @change='handleChangeEnd'
      style="width: 130px;"></el-input>
    <el-input v-model="Abs" class='inp' placeholder="请输入：λ Abs" @change='handleChangeAbs' style="width: 130px;">
    </el-input>
  </div>
</div>
