<template>
  <div class="uv-container">
    ...
    <el-table :data="tableData" style="width: 100%">
      ...
      <el-table-column prop="SampleName" label="日期" width="180">
      </el-table-column>
      <el-table-column prop="Location" label="日期" width="180">
      </el-table-column>
      <el-table-column prop="Pathlength Used" label="日期" width="180">
      </el-table-column>
      <el-table-column prop="Baseline" label="日期" width="180">
      </el-table-column>
      <el-table-column prop="Width" label="日期" width="180">
      </el-table-column>
      <el-table-column prop="Length" label="日期" width="180">
      </el-table-column>
      <el-table-column prop="Height" label="日期" width="180">
      </el-table-column>
    </el-table>
  </div>
</template>
