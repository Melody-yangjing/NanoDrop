<template>
  <div class="uv-container">
    ...
    <div class="header-container">
      ...
      <div class="right">
        <div class="pic">
          <img src="@/assets/End-Experiment-1.png" class="pic-icon" @click='console.log('haha');'/>
          <img src="@/assets/End-Experiment-2.png" class="pic-icon" @click='console.log('haha');'/>
          <img src="@/assets/End-Experiment-3.png" class="pic-icon" @click='console.log('haha');'/>
        </div>
