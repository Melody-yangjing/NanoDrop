<template>
  <div class="uv-container">
    ...
    <div class="input-box">
      <el-input v-model="dataZoomStart" class='inp' placeholder="请输入：λ Start" @change='handleChange'
        style="width: 130px;"></el-input>
      <el-input v-model="dataZoomStart" class='inp' placeholder="请输入：λ End" @change='handleChange'
        style="width: 130px;"></el-input>
      <el-input v-model="dataZoomStart" class='inp' placeholder="请输入：λ Abs" @change='handleChange'
        style="width: 130px;"></el-input>
    </div>
