<template>
  <div class="uv-container">
    ...
    <el-input v-model="dataZoomStart" placeholder="请输入：λ Start" @change='handleChange' style="width: 120px;"></el-input>
    <el-input v-model="dataZoomStart" placeholder="请输入：λ End" @change='handleChange' style="width: 120px;"></el-input>
    <el-input v-model="dataZoomStart" placeholder="请输入：λ Abs" @change='handleChange' style="width: 120px;"></el-input>
