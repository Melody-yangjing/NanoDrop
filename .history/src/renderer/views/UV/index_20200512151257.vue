<template>
  <div class="uv-container">
    ...
    <div class="switch-box">
      ...
      <el-switch v-model="Wavelength" active-color="#0080ff" active-text='Analytical Wavelength(nm) ' inactive-color="#ccc">
      </el-switch>
      <el-switch v-model="Correction" active-color="#0080ff" active-text='Baseline Correction(nm) ' inactive-color="#ccc">
      </el-switch>
    </div>
