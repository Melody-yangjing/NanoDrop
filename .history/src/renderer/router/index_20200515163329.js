...
export const constantRoutes = [
...

  {
    ...
    children: [
      ...
      { path: 'intensity', component: () => import('@/views/performance/index')},
      { path: 'pedestal', component: () => import('@/views/performance/index')},
      { path: 'settings', component: () => import('@/views/performance/index')},
      { path: 'help', component: () => import('@/views/performance/index')},
    ]
  },
